...
export const REPORTS: ReportDef[] = [
  ...
  {
    key: "pagamentos-atrasados",
    title: "Pagamentos atrasados",
    description: "Pagos depois do vencimento, mas dentro do mês de competência.",
    columns: [
      { key: "pagoEm", label: "Pago em", kind: "date" },
      { key: "cliente", label: "Cliente", kind: "text" },
      { key: "descricao", label: "Descrição", kind: "text" },
    ...
    filterFields: ["periodo", "cliente"],
    groupOptions: ["cliente", "responsavel"],
    defaultSort: { key: "pagoEm", dir: "desc" },
    build: buildPagamentosAtrasados,
  },
  {
    key: "pagos-outro-mes",
    title: "Pagamentos em mês diferente",
    description: "Pagos em mês posterior à competência — o mês original permaneceu inadimplente e o valor virou Receita Extra.",
    columns: [
      { key: "pagoEm", label: "Pago em", kind: "date" },
      { key: "cliente", label: "Cliente", kind: "text" },
      { key: "descricao", label: "Descrição", kind: "text" },
      { key: "competencia", label: "Competência original", kind: "text" },
      { key: "responsavel", label: "Responsável", kind: "text" },
      { key: "valor", label: "Valor", kind: "money", total: true },
    ],
    filterFields: ["periodo", "cliente"],
    groupOptions: ["competencia", "cliente"],
    defaultSort: { key: "pagoEm", dir: "desc" },
    build: buildPagosOutroMes,
  },
  {
    key: "receita-extra",
    title: "Receita Extra",
