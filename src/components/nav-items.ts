...
export const NAV_AREAS: NavArea[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { href: "/configuracoes/observabilidade", label: "Tempos do sistema", permission: "configuracoes.editar" },
      { href: "/catalogo", label: "Catálogo de componentes", permission: "configuracoes.editar" },
